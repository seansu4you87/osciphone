           ...
           fromLocation:(CLLocation *)oldLocation
{
    ...
    MoLocation::instance()->update(newLocation, oldLocation);
}
...
//-----------------------------------------------------------------------------
void MoLocation::add(const MoLocationCallback & callback, void * data )
{
    // one-time setup, if needed
    checkSetup();
...
//-----------------------------------------------------------------------------
void MoLocation::remove(const MoLocationCallback & callback )
{
    // one-time setup, if needed
    checkSetup();
